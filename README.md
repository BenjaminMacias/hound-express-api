...
[![Screenshot](.github/docs/screenshot.jpg)](https://github.com/nickjj/HoundExpressApi/blob/main/.github/docs/screenshot.jpg?raw=true)
...
```sh
git clone https://github.com/nickjj/HoundExpressApi HoundExpressApi
cd HoundExpressApi
...
The app is named `HoundExpressApi` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "HoundExpressApi" and update a few Docker related resources.
...
script](https://github.com/nickjj/HoundExpressApi/blob/main/bin/rename-project)
is going to:
...
you can [check it
out](https://github.com/nickjj/HoundExpressApi/blob/main/bin/rename-project)
...
the [run](https://github.com/nickjj/HoundExpressApi/blob/main/run) file
...
- [https://diveintodocker.com](https://diveintodocker.com?ref=HoundExpressApi)
