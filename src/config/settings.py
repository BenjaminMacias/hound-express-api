"""
Django settings for HoundExpressApi project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-dev-secret-key")  #<-- para desarrollo
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "HoundExpressApi"),
        "USER": os.getenv("POSTGRES_USER", "HoundExpressApi"),
